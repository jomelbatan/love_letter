    ...
    >
      <div className="mx-auto grid min-h-[calc(100svh-4.5rem)] max-w-7xl items-center gap-8 px-5 py-12 md:grid-cols-[0.9fr_1.1fr] md:py-16 lg:px-8">
        <div className="relative z-10 max-w-xl animate-rise">
          <div className="mb-5 inline-flex -rotate-2 items-center gap-2 rounded-sm bg-butter px-3 py-1.5 font-kalam-bold text-sm font-bold text-butter-foreground shadow-sm">
            <Sparkles className="size-4" /> no names, just little moments
          </div>
          <h1 className="font-kalam-bold text-5xl leading-[1.02] font-bold sm:text-6xl lg:text-7xl">
            ...
            <div className="flex -space-x-2" aria-hidden="true">
              {[
                ...
                <Image
                  ...
                  width={36}
                  height={36}
                  className="grid size-9 place-items-center rounded-full border-2 border-background bg-pure-chalk"
                />
              ))}
            </div>
        ...
        <div className="relative mx-auto w-full max-w-2xl animate-rise-delayed">
          <div className="absolute left-[5%] top-[8%] z-10 rotate-[-8deg] rounded-sm bg-pink px-4 py-2 font-kalam-bold text-sm font-bold shadow-sm">
            made with heart ♡
          </div>
          <div
          ...
          <div className="absolute bottom-[5%] right-[1%] rotate-[4deg] rounded-md border border-border bg-card p-3 shadow-paper">
            <p className="font-kalam-bold text-base font-bold">
              keep this moment
            </p>
